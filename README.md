...
A plastic recipe plaque originally conceived to survive:
- humidity
- grease
- steam
...
- Pause prints for:
  - insert
  - color swap
- Multiple pauses close together → set it, sleep, wake up to a finished batch
- 12-up on an AnkerMake M5C: ~4h19m (yes, really)
